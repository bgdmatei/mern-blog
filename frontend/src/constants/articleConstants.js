...
export const ARTICLE_LIST_DETAILS_REQUEST = 'ARTICLE_LIST_DETAILS_REQUEST';
export const ARTICLE_LIST_DETAILS_SUCCESS = 'ARTICLE_LIST_DETAILS_SUCCESS';
export const ARTICLE_LIST_DETAILS_FAIL = 'ARTICLE_LIST_DETAILS_FAIL';
